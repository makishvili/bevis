...
6. CSS-представление --> НАДО ПОНЯТЬ, КАК ОПИСАТЬ ЭТИ ЗАДАЧИ:
...
Итак, все сложности спрятаны за простым именем. Одного имени хватает для триединства. И в этом секрет простоты Бивиса.
