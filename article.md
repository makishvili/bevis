...
Что такое наш контроллер `index.page.js?` Выражаясь языком юристов, это "декларация о намерениях" :)
Мы декларируем, что наша страница будет состоять из нескольких логических кусков, например:
...
```
Тут мы заявили, что на странице будет всего два блока - шапка и форма авторизации. После наложения шаблонов, эта декларация превратится в
