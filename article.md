...
5. Зачем нужны декларативные шаблоны? --> НЕ ПОЛУЧАЕТСЯ ЗАПИСАТЬ В ЭТОЙ ГЛАВЕ ПРОФИТ. НЕ НАХОЖУ СЛОВ ПОДХОДЯЩИХ! НЕ ПОЛУЧАЕТСЯ ЧЁТКО!
...
6. Паттерн "Модуль" в CSS --> Надо понять, как описать эти задачи:
