...
Мощь в том, что эти функции приватны. Они не попадают напрямую в скомпилироанный css-файл. Пока я их конкретного селектора не выову этот миксин, я его не получу
...
а тестировать кнопки очень лего — у нас для этого есть специальная страница, которую отрываете в браузере и видите, как отображаюттся все существующие
вью кнопок. И всех других блоков в проекте
