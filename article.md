...
Содержимое главы:
* Управляемая последовательность стилей вместо множественных классов
* Абсолютная независимость стилей блоков друг от друга

Это делает инструмент Stylus (через единственный css-класс блока)

Здесь же:
* View и State - как часть отображения блока
* Здесь про автопрефиксер - сказать спасибо Ситнику за доклад в Минске, где впервые услышали про продукт и захотели.
