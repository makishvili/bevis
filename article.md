...
И предпредпоследня строка - это и есть вскинутая рука: "Свободная касса", "Модуль form готов к работе."
Благодаря чему другие модули тоже могут испольовать этот модуль
