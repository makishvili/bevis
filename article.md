...
Данные сохраняем в `index.data.js`, накладываем на них шаблоны представления, и отдаём пользователю конечный html.

Видите - схема та же. Только всё на яваскрипте.

Тут вы конечно спросите: зачем изобретать новый велосипед, если есть Смарти, есть Джанга, есть XSLT, в конце концов.
...
и после этого генерит из него `HTML`.

Что такое `BTJson?` Это способ описывать страницы. В статических сайтах страница описывается чистым html,
