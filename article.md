...
Только я один (разработчик проекта) знаю как должен выглядеть блок в той или иной ситуации. Это я должен сообщать браузеру, какой приоритет у селекторов.
Приоритет можно повысить треми способами:
