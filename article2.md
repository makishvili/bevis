...
Мы хотим, чтобы на странице появился такой html:
```html
<div class="header"></div>
```

Как мы пишем шаблон в Бивисе? Вот так. Обратите внмиание, это чистый валидный javascript.
```javascript
...
Только не где-нибудь, а в index.bt.js, то есть в файле с шаблонами. Посмотрите ещё раз на схему, чтобы соориентироваться.
