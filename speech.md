...
Видите - схема та же. Только всё на яваскрипте.


### Зачем перекрасили велосипед?

Мы не изобрели велосипед. Мы его перекрасили. Зачем? Если велосипедов сейчас на любой цвет в вкус?
И Смарти, и Джанга, и XSLT, назовите свой любимый?
...
Это набор `Javascript`-команд. Так как мы пишем на `Node.js`, наш яваскрипт завернут в `Node.js` модули.
...
```
Если вы на `Node.js` не писали, не пугайтесь. Не обращайте внимания на первую строку.
...
Почему блок? Зачем какой-то `JSON`? Почему нет `HTML`-тегов?
