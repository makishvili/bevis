...
Я прилетел к вам с юга Украины, и когда я вылетал, меня на Родине провожали жена и дочка, и погода там была прекрасная:

[солнце, зажмуренный я]

Когда я прилетел в Новосибирск, меня встретила зима и я немного подзамёрз.

[снег, замёрзий я в той же одежде, что на пред.фотке]

Но здесь, с вами, очень уютно и по-домашнему тепло. Спасибо вам, организаторы, за такую чудесную встречу.

Зачем я прилетел? Думаете, чтобы рассказать что-то оригинальное? Вы ошибаетесь.
Всё, что я расскажу, вы могли бы прочитать и сами, текст этого доклада уже есть на гитхабе.

Я прилетел вас познакомить с  необыкновенным человеком.

С человеком, который доказывает, что можно быть гениальным программистом и не быть занудой.

С человеком, который умеет не только писать качественный код, но и одновременно писать документацию к коду и его документация
прекрасная и понятная людям, а не роботом.

С человеком, продукты которого набирают популярность и внутри и снаружи Яндекса. Не так давно проекты jquery, bootstrap и angularjs стали
использовать один из проектов этого человека.

Знакомьтесь - мой очень хороший друг, и талантливейший программист — Марат Дулин!

После апплодисментов:

**Вадим:** В чём секрет твоих продуктов, Марат?

**Марат:** Спасибо, Вадим. Здравствуйте. Я считаю, что главное в программном продукте - это простота и понятность. Когда мы начинали придумывать Бивис,
мы страдали от боли. Чтобы создать сайт, есть куча фреймфорков, куча технологий, каждая со своими плюсами и минусами. У каждого свой порог сложности.
Нам это всё надоело. И мы сделали инструмент, который очень легко понять, и очень легко использовать. Мы опррбовали его на своих сервисах,
и поняли, что Бивис имеет право на жизнь. Сегодня мы хотим рассказать вам именно об этом.

**Вадим:** Спасибо, Марат. Да, мы должны сразу признаться вам. У нас нет никаких целей. Мы пришлю сюда просто, чтобы поговорить с вами.
Мы не ищем контрибьюторов, мы не говорим, что принесли вам новую веб-религию, и что срочно всем нужно переводить проекты на бивис.
Мы по-братски делимся с вами своими придумками. Окей? Тогда давайте начинать.

**Вадим:** Марат, расскажи мне, как устроено обычное MVC-приложение. Я когда писал на PHP, на Смарти. Я что-то помню.

**Марат:** Ок. Обычное MVC-приложение работает по стандартной схеме:
...
**Вадим:** Да, мне знакома эта схема.

**Марат:** Каждому знакома эта схема. Ну так мы её и не меняли.

**Вадим:** Бивис работает по этой же схеме?

**Марат:** Да, всё то же самое, только...
...
**Вадим:** Я так понимаю, вы сделали ещё один серверный велосипед, только на яваскрипте? Зачем? Ведь есть иСмарти, и Джанга, и XSLT. Сейчас и
клиентские всякие есть - Ангуляр тот же. Зачем ещё один?

**Марат:** Нет, велосипед мы взяли старый, только заменили в нём устаревшие детальки. У нас две причины:

1. Мы исповедуем простоту. Бивис настолько простой и понятный, что сверстать приложение на нём сможет даже школьник,
который чуть-чуть умеет на `html` / `css` / `javascript`. Ему не придётся изучать ни PHP, ни Ruby, ни Python, ни
Perl, Java, C#, XSL, продолжайте. Бесспорно, у каждого языка свои преимущества в определённых ситуациях.
Но мы и не говорим, что они не нужны. Мы говорим, что в 2014 году типовые задачи веб-разработки можно
успешно решать на серверном javascript. А javascript мы все знаем.

2. И вторая причина - асинхронность. Для больших проектов важна скорость. Да и просто модно, а мы ребята модные :)

**Вадим:** Мне нравится мысль, не учить серверные языки. Хотя, PHP я уже немного знаю. В PHP или в том же Python контроллер - это
набор PHP/Python-команд, которые ходят в бекенд за данными. А как выглядит ваш контроллер `index.page.js?`? Что внутри?

**Марат:** Это набор `Javascript`-команд. Так как мы пишем на `Node.js`, наш яваскрипт завернут в `Node.js` модули.
...
**Вадим:** первая строка - это что такое?

**Марат:** Если вы на `Node.js` не писали, не пугайтесь. Не обращайте внимания на первую строку.
Относитесь к ней, как обвязке, без которой нельзя. Всё интересное происходит внутри.
А внутри обычный `javascript`. Видите вызов функции `page.declare()`?

В бивис-приложении есть модуль `page`, у которого есть метод `declare`.
...
Скорее всего вы тоже разбиваете страницу на небольшие части, и называете их про себя как-то. Может быть модулями, может быть
компонентами или контролами. Мы называем блоками, потому что мы из Яндекса, а там родилась концепция верстки абсолютно независимыми блоками,
